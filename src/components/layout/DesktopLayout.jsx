...
export function DesktopLayout() {
    ...
    useEffect(() => {
        ...
        // Optional: Auto-collapse on resize to mobile (though this is strictly desktop layout now, good to keep for resizing windows)
        const handleResize = () => {
            // Logic kept for consistency, though 'useIsMobile' handles the switch at the root level now.
            // This might still be useful if someone resizes a desktop window very small but stays on "Desktop" view if we didn't force switch,
            // but our main switcher will handle the cutoff.
        };
